//DAILY  files for VIEWS  WITH PIVOT LOGIC
...
object DailyViews {
  ...
  def main(args: Array[String]) {
    ...
    //val colsToSort = pivotDF.columns.slice(pivotDF.columns.length - 1, pivotDF.columns.length).mkString
    ...
    // val rightColsList = colsToSum1.sorted(Ordering[String].reverse).toList
