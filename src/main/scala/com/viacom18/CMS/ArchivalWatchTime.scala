//Archival files for WATCHTIME WITH PIVOT LOGIC
...
object ArchivalWatchTime {

  def main(args: Array[String]) {

    // create Spark context with Spark configuration
    val spark = SparkSession.builder.appName("CMSArchivalWatchTime").enableHiveSupport().getOrCreate()
